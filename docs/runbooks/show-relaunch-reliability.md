...
| C14 | 매출/부분취소/정산 통화/CSV 회귀. 국내 PG gross/fee/net 대조, 외화 명세 155주문·203행 및 원화 지급 38,312,867원 대조. 별도 환불 362,000원은 운영자 송금 완료 확인 | 없음(이번 과거 정산 대조 범위). 다음 공연 실결제·정산 인수는 별도 |
...
국내·외화 PG 지급 합계는 `154,166,390 + 38,312,867 = 192,479,257원`이다. 운영자 확인 별도 환불 362,000원을 차감하면 192,117,257원이다. 운영 정산 화면에 외화 지급액 38,312,867원을 입력했을 때 표시되는 6,982,743원은 `유효 매출 199,462,000 - PG 지급 합계 192,479,257`이고, 별도 송금은 이 화면 식에 포함되지 않는다. 별도 송금 후 자금과의 차이는 7,344,743원이다. 두 차액 모두 미입금액·순이익·총수수료로 단정하지 않는다.
