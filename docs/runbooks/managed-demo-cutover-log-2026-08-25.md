...
- No Cloudflare Worker Route was deployed and no DNS or GCP load-balancer resource was deleted. The load balancer remains both the current edge origin path and a rollback asset, so its cost remains in the operating floor.
