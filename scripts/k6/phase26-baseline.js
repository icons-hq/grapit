...
const DEFAULT_PREALLOCATED_VUS = 100;
...
export const options = {
  ...
  scenarios: {
    phase26_10k_baseline: {
      executor: 'constant-arrival-rate',
      rate: intEnv('PHASE26_BASELINE_RATE', DEFAULT_RATE),
      timeUnit: __ENV.PHASE26_BASELINE_TIME_UNIT || '1s',
      duration: __ENV.PHASE26_BASELINE_DURATION || DEFAULT_DURATION,
      preAllocatedVUs: intEnv('PHASE26_BASELINE_PREALLOCATED_VUS', DEFAULT_PREALLOCATED_VUS),
      maxVUs: intEnv('PHASE26_BASELINE_MAX_VUS', DEFAULT_MAX_VUS),
      exec: 'baseline',
      tags: {
        phase: '26',
        gate: 'LOAD_10K_BASELINE',
        PHASE26_TEST,
      },
    },
  },
...
export function baseline() {
  const route = chooseRoute({
    readWeight: intEnv('PHASE26_READ_WEIGHT', 75),
    queueWeight: intEnv('PHASE26_QUEUE_WEIGHT', 20),
    mutationWeight: intEnv('PHASE26_MUTATION_WEIGHT', 5),
  });
