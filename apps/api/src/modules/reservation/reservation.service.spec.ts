...
describe('ReservationService', () => {
  ...
  // Seat cancellation transaction/PG outcomes are covered with real PostgreSQL in
  // test/show-relaunch.integration.spec.ts. That suite observes stored rights, money,
  // retries and inventory rather than mocking private SELECT/update call sequences.
